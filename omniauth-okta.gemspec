...
Gem::Specification.new do |s|
  ...
  s.homepage      = ''
  s.summary       = 'Unofficial OmniAuth OAuth2 strategy for Okta'
  s.description   = 'Unofficial OmniAuth OAuth2 strategy for Okta'
  s.license       = 'MIT'

  s.files = Dir['{app,config,db,lib}/**/*', 'MIT-LICENSE', 'Rakefile', 'README.md']

  s.add_dependency 'omniauth', '~> 1.5'
  s.add_dependency 'omniauth-oauth2', '>= 1.7.0', '< 2.0'
